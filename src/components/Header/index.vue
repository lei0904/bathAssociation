<template>
  <div class="header" :class="transparent ? 'transparent' : ''">
    <div class="transparent" v-if="transparent">
      ...
      <a href="#" @click.stop.prevent="share" class="share" v-if="shareable"></a>
    </div>
    <div v-else>
      <a href="#" @click.stop.prevent="back" class="back" v-if="backable"></a>
...
<script>
  import ShareDialog from '../Dialogs/Share/index';
...
<style lang="scss">
  ...
  .header.transparent .back {
    background: url("../../../static/image/back-transparent.png") no-repeat center;
    background-size: 66px 66px;
  }
  .header.transparent .share {
    background: url("../../../static/image/share-transparent.png") no-repeat center;
    background-size: 66px 66px;
  }
  ...
  .header .back {
    ...
    width: 88px;
    height: 100%;
    background: url("../../../static/image/back.png") no-repeat center;
